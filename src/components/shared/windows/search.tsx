...
import {InputTextContainer} from "components/shared/forms/inputText";
...
export const SearchContainer = styled.div`
  ...
  position: relative;
`;
export const SearchInputTextContainerStyle = styled(InputTextContainer)`
  position: relative; 
  &:before {
    content: "";
    position: absolute;
...
export const SearchResult = (props: {product: ProductType}) => {
    const click = () => { window.open(URLs.PRODUCT.replace(':id', '' + props.product.id));}
